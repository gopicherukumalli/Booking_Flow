...
public class PageUtils {
	...
	public static String RandomMailIDlog;
	...
	public static void scrollDown_card(WebDriver driver)
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public static void scrollUp1(WebDriver driver)
	{
	 ...
	 private static String[] Countries = {"Sudan","Syrian Arab Republic","Serbia"};
	 ...
	 private static Random rand = new Random();
	   ...
	   private static String[] emailrandom = {"mailsaudi.com","mailsa.net","mailerus.com","yelmail.com","mailerwork.com","mailsaudi.com","mailsa.net","mailerus.com","yelmail.com","mailerwork.com"};
	  
	   private static Random emailrand = new Random();

		   public static String generaterandomemail() {
	          
			   return emailrandom[emailrand.nextInt(emailrandom.length)];
		   } 
		   
		   public static String MailRandom() {
			   RandomMailID = generaterandomemail();
				//System.out.println("uniqueMailId: " + uniqueMailID);
				return RandomMailID;
			}
		   
		   
		   private static String[] emailrandomlog = {"mailsaudi.com","mailsa.net","mailerus.com","gmail.com","yelmail.com","mailerwork.com","mailerus.com"};
			
		   private static Random emailrandlog = new Random();

		   public static String generaterandomemaillog() {
	          
			   return emailrandomlog[emailrandlog.nextInt(emailrandomlog.length)];
		   } 
		   
		   public static String MailRandomlog() {
			   RandomMailIDlog = generaterandomemaillog();
				//System.out.println("uniqueMailId: " + uniqueMailID);
				return RandomMailIDlog;
			}
